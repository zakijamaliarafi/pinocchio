    ...
    ?>
        <div class="homepage-abis-login">
            <div class="div">
                ...
                <div class="text-wrapper-2" onclick="window.location.href='aboutus.php'">TENTANG KAMI</div>
                </div>
                ...
                <div class="overlap-wrapper">
                    <div class="div-wrapper" onclick="window.location.href='kategori.php'"><div class="text-wrapper-4">YUK MAIN</div></div>
                </div>
                </div>
                <footer class="FOOTER">
